...
class MovieLensDSHandler:
    ...
    def prepare_dataset(self):
        ...
        self.interactions_df = pd.concat([self.interactions_df, filtered_watched])
...
movieLensDSHandler = MovieLensDSHandler()
movieLensDSHandler.setup_datasource_data()
movieLensDSHandler.prepare_dataset()
movieLensDSHandler.write_data_set()
